...
public class Restricao {
	...
	private static String EXCECAO_METODO_GERAR = "O tipo de critério passado demanda a utilização do outro método \"Restricao.gerar()\".";

	private String nomeAtributo;
	private NomeAtributo nomeAtributo1; // atributo usado apenas na comparação
										// entre duas colunas da entidade
	private NomeAtributo nomeAtributo2; // atributo usado apenas na comparação
										// entre duas colunas da entidade
	 ...
	 * 
	 * @param nomeAtributo
	 *            Nome do atributo da classe que indicará o critério de
	 *            restrição.
	 * @param criterio
	 *            Indica o tipo de critérios utilizado na restriçãoo.
	 */
	 ...
	 * 
	 * @param restricao1
	 *            Restrição com os critérios que servirão para a primeira parte
	 *            do OR.
	 * @param restricao2
	 *            Restrição com os critérios que servirão para a segunda parte
	 *            do OR.
	 */
	...
	/**
	 * Construtor usado no caso do critério de restricao IN
	 * 
	 * @param nomeAtributo
	...
	/**
	 * Método usado para gerar restrições "in"
	 * 
	 * @param nome
	 * @param valores
	 * @return
	...
	public static Restricao gerarIn(String nome, List<? extends Object> valores) {
		if (valores.size() > 0) {
			...
			throw new RuntimeException("O uso do critério 'in' necessita de ter pelo menos um valor na lista de valores passados por parâmetro.");
		}
	}

	/**
	 * Método usado para gerar restrições "not in"
	 * 
	 * @param nome
	 * @param valores
	 * @return
	...
	public Criterion gerarRestricao() {
		...
		case BETWEEN:
			...
			break;
		default:
			throw new RuntimeException("O tipo de critério de restrição passado não é suportado. Cheque a classe CriterioRestricao.");
		}
	...
	/**
	 * Define o atributo utilizado na restrição.
	 * 
	 * @param nomeAtributo
	 *            Nome do atributo utilizado na restrição.
	 */
	...
	/**
	 * Retorna o nome do atributo utilizado na restrição.
	 */
    ...
    /**
	 * Retorna o tipo de critério usado na restrição.
	 */
	...
	/**
	 * Define o tipo de critério utilizado na restrição.
	 * 
	 * @param criterio
	 *            Enumerador utilizado para reconhecer o tipo de critério da
	 *            restrição.
	 */

...
/**
 * Essa classe se responsabiliza por organizar e gerar Alias de atributos compostos para que sejam criadas suas Restrições.
 * Há uma limitação, no entanto. A limitação ocorre quando enviamos nomes com mais de uma composição, conforme segue o exemplo abaixo:
 * 

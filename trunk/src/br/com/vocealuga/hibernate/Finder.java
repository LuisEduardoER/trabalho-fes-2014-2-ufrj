...
import br.com.vocealuga.util.UtilReflect;
...
public class Finder {
     ...
     * 
     * Esse método só retorna os atributos até 2 níveis a partir da entidade passada.
     * 
     * @param entidade
     * @return
     */
    ...
    /**
     * Um atributo é considerado direto se ele NAO é uma associacao.
     * 
     * @param entidade
     * @param nomeAtributo
     * @return
    ...
    /** Esse método converte uma lista de objetos em uma lista de ids.
     * 

...
public class Util {
	...
	public static boolean verdadeiro(Boolean booleano) {
		if(Util.preenchido(booleano)){
			return booleano;
		}else{
			return false;
		}
	...
	public static boolean isIphoneIpod(String userAgent){

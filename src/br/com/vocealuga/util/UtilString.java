...
public class UtilString {
    ...
    /**
     * ATENÇÃO: Só retorna números, se houver alguma string ela voltará como ""
     * 
     * @param string
     * @param delimitador
     * @return
     ...
     * @param delimitador
     * @return array de string com elementos delimitados pelo parâmetro delimitador
     */
    ...
    /**
     * Informa o número de delimitadores presentes em uma string
     * 
     * @param string String que será analisada
     * @param delimitador String delimitadora que será procurada na "string"
     * @return número de delimitadores presentes em uma string
     */
    ...
    /**
     * Troca todos os pontos (".") de uma string por vírgula (",").
     * 
    ...
    /**
     * Troca todas as vírgulas (",") de uma string por pontos (".").
     * 
     * @param string String que será alterada
     * @return String alterada
     */
    ...
    /**
     * Retira todos os símbolos de uma String
     * 
     * @param numero
     * @return
     */
     ...
     * Não permite código HTML no conteúdo da mensagem*/
    ...
    /**
     * retorna true se a string passada é um "on"
     * @param str
     * @return
     */
    ...
    /**
     * Adiciona zeros a esquerda do texto até ele chegar ao tamanho desejável
     * @param texto
